...
export const registerRequest = async (email: string, name: string, last_name: string, phone: string, password: string) => {
    await axi.post("/users/register/", { email, name, last_name, phone, password })
};
