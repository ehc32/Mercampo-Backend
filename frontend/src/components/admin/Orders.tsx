import SearchIcon from '@mui/icons-material/Search'; // O el ícono que prefieras
          ...
          <tbody>
            {data.map((o: any) => (
              <tr key={o.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:dark:hover:bg-gray-600">
                <td className="px-2  py-1 text-center">{o.user}</td>
            ...
            <tbody>
              {selectedOrderProducts.length > 0 ? (
                selectedOrderProducts.map((product: any) => (
                  <tr key={product.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:dark:hover:bg-gray-600">
                    <td className="px-6 py-1 text-center">{product.product}</td>
                ...
                <tr>
                  <td colSpan={4} className="px-6 py-1 text-center">No se encontraron productos</td>
                </tr>
              )}
            </tbody>
          </table>
