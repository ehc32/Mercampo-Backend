        ...
        <div className="w-full lg:w-1/2 bg-white lg:max-w-sm mb-8 lg:mb-0 shadow dark:bg-gray-800 dark:border-gray-700 border border-gray-200 rounded-lg">
          {show ? (
            <>
              ...
              <div className="flex flex-col items-start  px-2 w-full h-48 justify-between     ">
                <div className="flex items-center justify-between w-full card-bordered bg-white p-4 rounded-lg pl-10" >
                  {user && user.avatar !== undefined && (
                    <div className="flex flex-col card-bordered">
                      <img
