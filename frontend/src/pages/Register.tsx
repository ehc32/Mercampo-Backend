        ...
        <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              name="email"
              id="email"
              className="bg-gray-50 border border-gray-300 text-gray-100 sm:text-sm rounded-lg block w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-200"
          ...
          <div>
            ...
            <input
              ...
              id="password"
              placeholder="••••••••"
              className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg block w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-200"
            />
          </div>
