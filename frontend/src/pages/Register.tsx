...
const RegisterPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="flex-grow flex flex-col justify-center px-4 pt-20 pb-10 mx-auto fondo-login">
        <div className="w-full max-w-md bg-slate-300 bg-opacity-20 backdrop-filter backdrop-blur-md rounded-lg shadow dark:border dark:bg-gray-800 dark:bg-opacity-20 dark:backdrop-blur-md dark:border-gray-700 mx-auto">
