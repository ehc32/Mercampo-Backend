  ...
  useEffect(() => {
    ...
    const finalizeOrder = async () => {
      if (paymentId && externalReference) {
        try {
          // Implementa la función directamente en el componente
          const response = await authAxios.post("/orders/payment/finalize/", {
            payment_id: paymentId,
            external_reference: externalReference,
          })

          // Si la orden se crea, se obtiene el order_id
    ...
    <section className="bg-white p-6 sm:p-10 mt-10">
      <div className="max-w-3xl mx-auto text-center">
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">Tu pago ha sido procesado correctamente.</p>
        </div>
